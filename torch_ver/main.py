...
def data_loader():
    ...
    data_set = datasets.CIFAR10(root='./data', train=True, download=False, transform=pre_processing)
    test_data = datasets.CIFAR10(root='./data', train=False, download=False, transform=pre_processing)
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        valid(valid_loader, net, loss_fn)
    print("Done!")
